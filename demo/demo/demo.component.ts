...
import {IDatePickerModalConfig} from '../../date-picker/date-picker-config.model';
import {DatePickerModalComponent} from '../../date-picker/date-picker.component';
import {DatePickerModalDirective} from '../../date-picker/date-picker.directive';
...
export class DemoComponent {
  ...
  @ViewChild('dateComponent') dateComponent: DatePickerModalComponent;
  @ViewChild('donateForm') donateForm: any;
  @ViewChild('dateDirectivePicker') datePickerModalDirective: DatePickerModalDirective;
  ...
  jalaliConfigExtension: IDatePickerModalConfig = {
    firstDayOfWeek: 'sa',
    monthFormat: 'MMMM YY',
    weekDayFormat: 'dd',
    dayBtnFormat: 'D',
  ...
  gregorianSystemDefaults: IDatePickerModalConfig = {
    firstDayOfWeek: 'su',
  ...
  config: IDatePickerModalConfig = {...this.gregorianSystemDefaults, ...this.jalaliConfigExtension};
  formGroup: FormGroup = new FormGroup({
    datePickerModal: new FormControl({value: null, disabled: this.disabled}, [
  ...
  modeChanged(mode) {
    ...
    this.formGroup.get('datePickerModal').setValue(this.date);

    this.gaService.emitEvent('Navigation', mode);
  }

  validatorsChanged() {
    this.formGroup.get('datePickerModal').updateValueAndValidity();
  }
  ...
  openCalendar() {
    ...
    } else if (this.datePickerModalDirective) {
      this.datePickerModalDirective.api.open();
    }
  }
  ...
  closeCalendar() {
    if (this.dateComponent) {
      ...
      this.datePickerModalDirective.api.close();
    }
  }
